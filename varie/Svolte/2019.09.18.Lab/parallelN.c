...
int main(int argc, char *argv[])
{
    ...
    /*converte stringa in intero (numero massimo di processi attivi*/*/
    const int MAXPROC = atoi(argv[1]);
    ...
    { 
        ...
        /*se sono gia' troppi in esecuzione aspetta uno*/
        if (num_of_commands == MAXPROC)
        {
            int status;
            wait(&status);
            num_of_commands--;
